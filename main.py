from orm.models import create_tables_orm
from orm.author import Author_table_orm
from orm.genre import Genre_table_orm
from orm.book import Book_table_orm
from raw.models import create_tables_raw
from raw.author import Author_table_raw
from raw.genre import Genre_table_raw
from raw.book import Book_table_raw
...
def main():
    ...
    while True:
        print(
            "\nМеню:\n"
            "0. Выйти\n"
            "1. Работать с БД через psycopg\n"
            "2. Работать с БД через sqlalchemy\n"
        )
        ...
        if choice == "0":
            ...
            create_tables_raw()
            Author = Author_table_raw
            Genre = Genre_table_raw
            Book = Book_table_raw
        elif choice == "2":
            create_tables_orm()
        ...
        while True:
            print(
                ...
                "4. Вывести запись из таблицы author\n"
                "5. Вывести запись из таблицы genre\n"
                "6. Вывести запись из таблицы book\n"
